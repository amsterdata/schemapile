...
def main():
    ...
    raw_datasets = load_dataset("parquet", data_files={'train': data_args.dataset_name+"/train.parquet"}) # , 'test': data_args.dataset_name+"/test.parquet"
    if data_args.max_train_samples is not None:
            max_train_samples = min(len(raw_datasets['train']), data_args.max_train_samples)
            raw_datasets['train'] = raw_datasets['train'].select(random.sample(range(len(raw_datasets['train'])), max_train_samples))
    logger.info(
