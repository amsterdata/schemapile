...
class SQLGlot(FileHandler):
    def __init__(self, file_path, encoding):
        ...
        #self.other_dialects = [dia.lower() for dia in Dialects if dia.lower() not in self.mandatory_dialects and dia.lower() != ""]
    ...
    def parse_one(self, stmt, id=None):
        ...
        if _result['num_comment_stmt'] >0:
            raise sqlglot.errors.ParseError("contains command")
